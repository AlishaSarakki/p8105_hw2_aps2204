...
Of all distinct stations that serve the A, the following number are ADA
compliant.
...
```
    ...
    ## # A tibble: 822 x 9
    ##    year  gov_gop sen_gop rep_gop gov_dem sen_dem rep_dem month_name president
...
```
    ...
    ## # … with 2 more variables: rep_dem <dbl>, month_name <chr>
